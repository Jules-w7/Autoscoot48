...
--
-- Client :  localhost
-- Généré le :  Ven 24 Mai 2024 à 07:13
...
--
-- Contenu de la table `t_carbrand`
--
...
--
-- Contenu de la table `t_carengtype`
--
...
(5, 'Violet', 30000, 'Polo', 100000, 'Rue du sebeillon 12', 'Grosse rayure sur tout le cote droit de la voiture', '1', '2', '../images/carPictures/PoloGris.JPG'),
...
(31, 'Noir', 1997, 'Multipla', 259000, 'Rue du sÃ©beillon 12', 'Pas fait lexpertise', '1', '12', '../images/carPictures/FiatMultipla.JPG');
...
--
ALTER TABLE `t_carbrand`
  MODIFY `idCarBrand` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `t_cars`
  MODIFY `idCar` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
